<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('table.examRecord.submitStatus')" min-width="90" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.actions')" class-name="status-col" width="300px">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="handleUpdate(scope.row)">{{ $t('table.examRecord.details') }}</el-button>
